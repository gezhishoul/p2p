...
<div class="myAccount container mt30 clearFix">
    <div class="fr colorWhiteBg myAccountCenter cash">
        <form action="">
            ...
            <hr class="mt30"/>
            <h2 class="mt20">填写提现金额</h2>
            <div class="cashArea mt20">
                <div class="inputItem">
                    <label class="uiLabel">可用资金</label>
                    <span class="numberLarge"><em>0.00</em>元</span>
                </div>
                <div class="inputItem mt10">
                    <label class="uiLabel" for="cashMoney">充值金额</label>
                    <input type="text" id="cashMoney"/>元
                    <p class="danger disn">提现金额格式不正确</p>
                </div>
                <div class="inputItem mt10">
                    <label class="uiLabel">提现费用</label>
                    <span class="numberLarge"><em>0.00</em>元</span>
                </div>
                <div class="inputItem mt10">
                    <label class="uiLabel">实际扣除金额</label>
                    <span class="numberLarge"><em>0.00</em>元</span>
                </div>
                <div class="inputItem mt10">
                    <label class="uiLabel" for="cashCode">提现密码</label>
                    <input type="text" id="cashCode" class="mr10"/><a class="themeCor" href="">忘记密码</a>
                    <p class="danger disn">密码不正确</p>
                </div>
                <div class="mt30">
                    <button type="submit" class="themeBtn" id="cashBtn">充值</button>
                </div>
            </div>
        </form>
    </div>
